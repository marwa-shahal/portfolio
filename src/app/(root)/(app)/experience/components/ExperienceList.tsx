  ...
  return (
    <div className="space-y-12">
      {experience.map((item) => (
        <div
          key={item.id}
          className="relative py-8 pl-8 sm:pl-16 border border-black/5 bg-white/30 backdrop-blur dark:border-white/5 dark:bg-black/30"
        >
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start mb-2 sm:w-[90%]">
            ...
            <div className="sm:w-40 flex-shrink-0 mb-1 sm:mb-0">
              <p className="text-sm font-medium text-gray-500 dark:text-gray-400">{item.period}</p>
            </div>
          </div>
